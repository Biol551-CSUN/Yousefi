...
penguins <- penguins %>% mutate(sex = fct_recode(sex, "Male" = "male", 
                                                 "Female" = "female")) # Properly capitalize the sexes
...
ggsave(here("Week_3","Output","Week3_Homework_groupplot.png"), 
